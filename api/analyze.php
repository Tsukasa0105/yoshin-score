...
<div class="financial-scoring-report">
  ...
  <section class="scoring-detail">
    ...
    <table>
      ...
      <tbody>
        <tr><td>2-1. 自己資本比率</td><td>XX,XXX千円 ÷ XX,XXX千円 × 100 = XX.X%</td><td>[該当区分]</td><td>XX点</td><td>40点</td></tr>
        <tr><td>2-2. 営業利益（直近2期）</td><td>直近：黒字／前期：黒字</td><td>[該当区分]</td><td>XX点</td><td>30点</td></tr>
        <tr><td>2-3. 流動比率</td><td>XX,XXX千円 ÷ XX,XXX千円 × 100 = XX.X%</td><td>[該当区分]</td><td>XX点</td><td>16点</td></tr>
        <tr><td>2-4. 有利子負債月商倍率</td><td>XX,XXX千円 ÷（XXX,XXX千円 ÷ 12）= X.Xヶ月</td><td>[該当区分]</td><td>XX点</td><td>14点</td></tr>
        <tr class="total"><td><strong>合計</strong></td><td>-</td><td>-</td><td><strong>XX点</strong></td><td><strong>100点</strong></td></tr>
      </tbody>
    </table>
  </section>
...
5. コメント：70点以上→「適格。資金調達実現可能性が高い水準」、50〜69点→「要検討。改善余地あり、追加情報の確認推奨」、30〜49点→「課題多。財務改善コンサル先行を推奨」、29点以下→「不適格。現状での資金調達は困難」、足切り→「審査NG。債務超過の解消が先決」。
